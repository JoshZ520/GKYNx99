// session-utilities.js - Game session persistence and management
...
class GameSessionManager {
    ...
    validateSessionData(sessionData) {
        return sessionData && 
               ...
               Array.isArray(sessionData.playerNames) &&
               Array.isArray(sessionData.chronologicalSubmissions);
    }
    ...
    importSession(sessionJsonString) {
        try {
            const sessionData = JSON.parse(sessionJsonString);
            ...
            this.saveSessionData(newSessionId, sessionData);
            console.log(`Imported session as: ${newSessionId}`);
...
window.addEventListener('beforeunload', () => {
    if (window.gameSessionManager && window.gameSessionManager.getCurrentSessionId()) {
